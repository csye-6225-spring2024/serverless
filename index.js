...
export const handleNewUserAccount = async (event, context) => {
...
const sendVerificationEmail = async (username, token) => {
  try {
    ...
    const data = {
      ...
      text: `Please click the following link to verify your email: ${generateVerificationLink(username, token)}`,
    };
...
const generateVerificationLink = (username, token) => {
